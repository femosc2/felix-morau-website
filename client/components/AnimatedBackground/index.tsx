...
import { StyledAnimatedBackground } from "./AnimatedBackground.styles";

interface IProps {
  currPos: number;
}

const AnimatedBackground = (props: IProps) => {
  const { currPos } = props;
  return (
    <StyledAnimatedBackground currPos={currPos} id="bg-wrap">
      <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
        ...
        {/* Uncomment the following lines if you want to render the rects */}
